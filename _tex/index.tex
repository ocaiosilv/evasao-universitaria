...
title: Análise de Evasão Universitária usando Polars authors: - name:
Caio Aloísio Andrade Silva affiliation: Universidade Federal de Sergipe
roles: writing corresponding: true - name: Gabriel Santos de Souza
affiliation: Universidade Federal de Sergipe roles: writing
corresponding: true - name: Lucca Pedreira Dultra affiliation:
Universidade Federal de Sergipe roles: writing corresponding: true -
name: Renato Vasconcelos Campos Filho affiliation: Universidade Federal
de Sergipe roles: writing corresponding: true - name: Tarcísio Almeida
Mascarenhas affiliation: Universidade Federal de Sergipe roles: writing
corresponding: true bibliography: references.bib csl:
...
\textsubscript{Source:
\href{https://ocaiosilv.github.io/evasao-universitaria-polars/index.qmd.html}{Article
Notebook}}
